var At=Object.defineProperty;var Ye=e=>{throw TypeError(e)};var Ct=(e,t,r)=>t in e?At(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var h=(e,t,r)=>Ct(e,typeof t!="symbol"?t+"":t,r),Me=(e,t,r)=>t.has(e)||Ye("Cannot "+r);var o=(e,t,r)=>(Me(e,t,"read from private field"),r?r.call(e):t.get(e)),u=(e,t,r)=>t.has(e)?Ye("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),m=(e,t,r,a)=>(Me(e,t,"write to private field"),a?a.call(e,r):t.set(e,r),r),b=(e,t,r)=>(Me(e,t,"access private method"),r);var Ke=(e,t,r,a)=>({set _(s){m(e,t,s,r)},get _(){return o(e,t,a)}});var Ve=(e,t,r)=>(a,s)=>{let i=-1;return n(0);async function n(l){if(l<=i)throw new Error("next() called multiple times");i=l;let c,d=!1,p;if(e[l]?(p=e[l][0][0],a.req.routeIndex=l):p=l===e.length&&s||void 0,p)try{c=await p(a,()=>n(l+1))}catch(f){if(f instanceof Error&&t)a.error=f,c=await t(f,a),d=!0;else throw f}else a.finalized===!1&&r&&(c=await r(a));return c&&(a.finalized===!1||d)&&(a.res=c),a}},Tt=Symbol(),Ot=async(e,t=Object.create(null))=>{const{all:r=!1,dot:a=!1}=t,i=(e instanceof ft?e.raw.headers:e.headers).get("Content-Type");return i!=null&&i.startsWith("multipart/form-data")||i!=null&&i.startsWith("application/x-www-form-urlencoded")?zt(e,{all:r,dot:a}):{}};async function zt(e,t){const r=await e.formData();return r?Rt(r,t):{}}function Rt(e,t){const r=Object.create(null);return e.forEach((a,s)=>{t.all||s.endsWith("[]")?Ft(r,s,a):r[s]=a}),t.dot&&Object.entries(r).forEach(([a,s])=>{a.includes(".")&&(Pt(r,a,s),delete r[a])}),r}var Ft=(e,t,r)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(r):e[t]=[e[t],r]:t.endsWith("[]")?e[t]=[r]:e[t]=r},Pt=(e,t,r)=>{if(/(?:^|\.)__proto__\./.test(t))return;let a=e;const s=t.split(".");s.forEach((i,n)=>{n===s.length-1?a[i]=r:((!a[i]||typeof a[i]!="object"||Array.isArray(a[i])||a[i]instanceof File)&&(a[i]=Object.create(null)),a=a[i])})},ot=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},Lt=e=>{const{groups:t,path:r}=It(e),a=ot(r);return Dt(a,t)},It=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(r,a)=>{const s=`@${a}`;return t.push([s,r]),s}),{groups:t,path:e}},Dt=(e,t)=>{for(let r=t.length-1;r>=0;r--){const[a]=t[r];for(let s=e.length-1;s>=0;s--)if(e[s].includes(a)){e[s]=e[s].replace(a,t[r][1]);break}}return e},ze={},Ht=(e,t)=>{if(e==="*")return"*";const r=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(r){const a=`${e}#${t}`;return ze[a]||(r[2]?ze[a]=t&&t[0]!==":"&&t[0]!=="*"?[a,r[1],new RegExp(`^${r[2]}(?=/${t})`)]:[e,r[1],new RegExp(`^${r[2]}$`)]:ze[a]=[e,r[1],!0]),ze[a]}return null},qe=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,r=>{try{return t(r)}catch{return r}})}},nt=e=>qe(e,decodeURI),lt=e=>{const t=e.url,r=t.indexOf("/",t.indexOf(":")+4);let a=r;for(;a<t.length;a++){const s=t.charCodeAt(a);if(s===37){const i=t.indexOf("?",a),n=t.indexOf("#",a),l=i===-1?n===-1?void 0:n:n===-1?i:Math.min(i,n),c=t.slice(r,l);return nt(c.includes("%25")?c.replace(/%25/g,"%2525"):c)}else if(s===63||s===35)break}return t.slice(r,a)},Nt=e=>{const t=lt(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},K=(e,t,...r)=>(r.length&&(t=K(t,...r)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),ct=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),r=[];let a="";return t.forEach(s=>{if(s!==""&&!/\:/.test(s))a+="/"+s;else if(/\:/.test(s))if(/\?/.test(s)){r.length===0&&a===""?r.push("/"):r.push(a);const i=s.replace("?","");a+="/"+i,r.push(a)}else a+="/"+s}),r.filter((s,i,n)=>n.indexOf(s)===i)},$e=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?qe(e,pt):e):e,dt=(e,t,r)=>{let a;if(!r&&t&&!/[%+]/.test(t)){let n=e.indexOf("?",8);if(n===-1)return;for(e.startsWith(t,n+1)||(n=e.indexOf(`&${t}`,n+1));n!==-1;){const l=e.charCodeAt(n+t.length+1);if(l===61){const c=n+t.length+2,d=e.indexOf("&",c);return $e(e.slice(c,d===-1?void 0:d))}else if(l==38||isNaN(l))return"";n=e.indexOf(`&${t}`,n+1)}if(a=/[%+]/.test(e),!a)return}const s={};a??(a=/[%+]/.test(e));let i=e.indexOf("?",8);for(;i!==-1;){const n=e.indexOf("&",i+1);let l=e.indexOf("=",i);l>n&&n!==-1&&(l=-1);let c=e.slice(i+1,l===-1?n===-1?void 0:n:l);if(a&&(c=$e(c)),i=n,c==="")continue;let d;l===-1?d="":(d=e.slice(l+1,n===-1?void 0:n),a&&(d=$e(d))),r?(s[c]&&Array.isArray(s[c])||(s[c]=[]),s[c].push(d)):s[c]??(s[c]=d)}return t?s[t]:s},Mt=dt,$t=(e,t)=>dt(e,t,!0),pt=decodeURIComponent,Je=e=>qe(e,pt),le,T,M,mt,ht,Ge,L,et,ft=(et=class{constructor(e,t="/",r=[[]]){u(this,M);h(this,"raw");u(this,le);u(this,T);h(this,"routeIndex",0);h(this,"path");h(this,"bodyCache",{});u(this,L,e=>{const{bodyCache:t,raw:r}=this,a=t[e];if(a)return a;const s=Object.keys(t)[0];return s?t[s].then(i=>(s==="json"&&(i=JSON.stringify(i)),new Response(i)[e]())):t[e]=r[e]()});this.raw=e,this.path=t,m(this,T,r),m(this,le,{})}param(e){return e?b(this,M,mt).call(this,e):b(this,M,ht).call(this)}query(e){return Mt(this.url,e)}queries(e){return $t(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((r,a)=>{t[a]=r}),t}async parseBody(e){return Ot(this,e)}json(){return o(this,L).call(this,"text").then(e=>JSON.parse(e))}text(){return o(this,L).call(this,"text")}arrayBuffer(){return o(this,L).call(this,"arrayBuffer")}bytes(){return o(this,L).call(this,"arrayBuffer").then(e=>new Uint8Array(e))}blob(){return o(this,L).call(this,"blob")}formData(){return o(this,L).call(this,"formData")}addValidatedData(e,t){o(this,le)[e]=t}valid(e){return o(this,le)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Tt](){return o(this,T)}get matchedRoutes(){return o(this,T)[0].map(([[,e]])=>e)}get routePath(){return o(this,T)[0].map(([[,e]])=>e)[this.routeIndex].path}},le=new WeakMap,T=new WeakMap,M=new WeakSet,mt=function(e){const t=o(this,T)[0][this.routeIndex][1][e],r=b(this,M,Ge).call(this,t);return r&&/\%/.test(r)?Je(r):r},ht=function(){const e={},t=Object.keys(o(this,T)[0][this.routeIndex][1]);for(const r of t){const a=b(this,M,Ge).call(this,o(this,T)[0][this.routeIndex][1][r]);a!==void 0&&(e[r]=/\%/.test(a)?Je(a):a)}return e},Ge=function(e){return o(this,T)[1]?o(this,T)[1][e]:e},L=new WeakMap,et),Wt={Stringify:1},ut=async(e,t,r,a,s)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const i=e.callbacks;return i!=null&&i.length?(s?s[0]+=e:s=[e],Promise.all(i.map(l=>l({phase:t,buffer:s,context:a}))).then(l=>Promise.all(l.filter(Boolean).map(c=>ut(c,t,!1,a,s))).then(()=>s[0]))):Promise.resolve(e)},Gt="text/plain; charset=UTF-8",We=(e,t)=>({"Content-Type":e,...t}),be=(e,t)=>new Response(e,t),ke,Ee,I,ce,D,A,je,de,pe,X,Be,Se,W,oe,tt,qt=(tt=class{constructor(e,t){u(this,W);u(this,ke);u(this,Ee);h(this,"env",{});u(this,I);h(this,"finalized",!1);h(this,"error");u(this,ce);u(this,D);u(this,A);u(this,je);u(this,de);u(this,pe);u(this,X);u(this,Be);u(this,Se);h(this,"render",(...e)=>(o(this,de)??m(this,de,t=>this.html(t)),o(this,de).call(this,...e)));h(this,"setLayout",e=>m(this,je,e));h(this,"getLayout",()=>o(this,je));h(this,"setRenderer",e=>{m(this,de,e)});h(this,"header",(e,t,r)=>{this.finalized&&m(this,A,be(o(this,A).body,o(this,A)));const a=o(this,A)?o(this,A).headers:o(this,X)??m(this,X,new Headers);t===void 0?a.delete(e):r!=null&&r.append?a.append(e,t):a.set(e,t)});h(this,"status",e=>{m(this,ce,e)});h(this,"set",(e,t)=>{o(this,I)??m(this,I,new Map),o(this,I).set(e,t)});h(this,"get",e=>o(this,I)?o(this,I).get(e):void 0);h(this,"newResponse",(...e)=>b(this,W,oe).call(this,...e));h(this,"body",(e,t,r)=>b(this,W,oe).call(this,e,t,r));h(this,"text",(e,t,r)=>!o(this,X)&&!o(this,ce)&&!t&&!r&&!this.finalized?new Response(e):b(this,W,oe).call(this,e,t,We(Gt,r)));h(this,"json",(e,t,r)=>b(this,W,oe).call(this,JSON.stringify(e),t,We("application/json",r)));h(this,"html",(e,t,r)=>{const a=s=>b(this,W,oe).call(this,s,t,We("text/html; charset=UTF-8",r));return typeof e=="object"?ut(e,Wt.Stringify,!1,{}).then(a):a(e)});h(this,"redirect",(e,t)=>{const r=String(e);return this.header("Location",/[^\x00-\xFF]/.test(r)?encodeURI(r):r),this.newResponse(null,t??302)});h(this,"notFound",()=>(o(this,pe)??m(this,pe,()=>be()),o(this,pe).call(this,this)));m(this,ke,e),t&&(m(this,D,t.executionCtx),this.env=t.env,m(this,pe,t.notFoundHandler),m(this,Se,t.path),m(this,Be,t.matchResult))}get req(){return o(this,Ee)??m(this,Ee,new ft(o(this,ke),o(this,Se),o(this,Be))),o(this,Ee)}get event(){if(o(this,D)&&"respondWith"in o(this,D))return o(this,D);throw Error("This context has no FetchEvent")}get executionCtx(){if(o(this,D))return o(this,D);throw Error("This context has no ExecutionContext")}get res(){return o(this,A)||m(this,A,be(null,{headers:o(this,X)??m(this,X,new Headers)}))}set res(e){if(o(this,A)&&e){e=be(e.body,e);for(const[t,r]of o(this,A).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const a=o(this,A).headers.getSetCookie();e.headers.delete("set-cookie");for(const s of a)e.headers.append("set-cookie",s)}else e.headers.set(t,r)}m(this,A,e),this.finalized=!0}get var(){return o(this,I)?Object.fromEntries(o(this,I)):{}}},ke=new WeakMap,Ee=new WeakMap,I=new WeakMap,ce=new WeakMap,D=new WeakMap,A=new WeakMap,je=new WeakMap,de=new WeakMap,pe=new WeakMap,X=new WeakMap,Be=new WeakMap,Se=new WeakMap,W=new WeakSet,oe=function(e,t,r){const a=o(this,A)?new Headers(o(this,A).headers):o(this,X)??new Headers;if(typeof t=="object"&&"headers"in t){const i=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[n,l]of i)n.toLowerCase()==="set-cookie"?a.append(n,l):a.set(n,l)}if(r)for(const[i,n]of Object.entries(r))if(typeof n=="string")a.set(i,n);else{a.delete(i);for(const l of n)a.append(i,l)}const s=typeof t=="number"?t:(t==null?void 0:t.status)??o(this,ce);return be(e,{status:s,headers:a})},tt),w="ALL",_t="all",Ut=["get","post","put","delete","options","patch"],gt="Can not add a route since the matcher is already built.",vt=class extends Error{},Yt="__COMPOSED_HANDLER",Kt=e=>e.text("404 Not Found",404),Xe=(e,t)=>{if("getResponse"in e){const r=e.getResponse();return t.newResponse(r.body,r)}return console.error(e),t.text("Internal Server Error",500)},O,k,bt,z,V,Re,Fe,fe,Vt=(fe=class{constructor(t={}){u(this,k);h(this,"get");h(this,"post");h(this,"put");h(this,"delete");h(this,"options");h(this,"patch");h(this,"all");h(this,"on");h(this,"use");h(this,"router");h(this,"getPath");h(this,"_basePath","/");u(this,O,"/");h(this,"routes",[]);u(this,z,Kt);h(this,"errorHandler",Xe);h(this,"onError",t=>(this.errorHandler=t,this));h(this,"notFound",t=>(m(this,z,t),this));h(this,"fetch",(t,...r)=>b(this,k,Fe).call(this,t,r[1],r[0],t.method));h(this,"request",(t,r,a,s)=>t instanceof Request?this.fetch(r?new Request(t,r):t,a,s):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${K("/",t)}`,r),a,s)));h(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(b(this,k,Fe).call(this,t.request,t,void 0,t.request.method))})});[...Ut,_t].forEach(i=>{this[i]=(n,...l)=>(typeof n=="string"?m(this,O,n):b(this,k,V).call(this,i,o(this,O),n),l.forEach(c=>{b(this,k,V).call(this,i,o(this,O),c)}),this)}),this.on=(i,n,...l)=>{for(const c of[n].flat()){m(this,O,c);for(const d of[i].flat())l.map(p=>{b(this,k,V).call(this,d.toUpperCase(),o(this,O),p)})}return this},this.use=(i,...n)=>(typeof i=="string"?m(this,O,i):(m(this,O,"*"),n.unshift(i)),n.forEach(l=>{b(this,k,V).call(this,w,o(this,O),l)}),this);const{strict:a,...s}=t;Object.assign(this,s),this.getPath=a??!0?t.getPath??lt:Nt}route(t,r){const a=this.basePath(t);return r.routes.map(s=>{var n;let i;r.errorHandler===Xe?i=s.handler:(i=async(l,c)=>(await Ve([],r.errorHandler)(l,()=>s.handler(l,c))).res,i[Yt]=s.handler),b(n=a,k,V).call(n,s.method,s.path,i,s.basePath)}),this}basePath(t){const r=b(this,k,bt).call(this);return r._basePath=K(this._basePath,t),r}mount(t,r,a){let s,i;a&&(typeof a=="function"?i=a:(i=a.optionHandler,a.replaceRequest===!1?s=c=>c:s=a.replaceRequest));const n=i?c=>{const d=i(c);return Array.isArray(d)?d:[d]}:c=>{let d;try{d=c.executionCtx}catch{}return[c.env,d]};s||(s=(()=>{const c=K(this._basePath,t),d=c==="/"?0:c.length;return p=>{const f=new URL(p.url);return f.pathname=this.getPath(p).slice(d)||"/",new Request(f,p)}})());const l=async(c,d)=>{const p=await r(s(c.req.raw),...n(c));if(p)return p;await d()};return b(this,k,V).call(this,w,K(t,"*"),l),this}},O=new WeakMap,k=new WeakSet,bt=function(){const t=new fe({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,m(t,z,o(this,z)),t.routes=this.routes,t},z=new WeakMap,V=function(t,r,a,s){t=t.toUpperCase(),r=K(this._basePath,r);const i={basePath:s!==void 0?K(this._basePath,s):this._basePath,path:r,method:t,handler:a};this.router.add(t,r,[a,i]),this.routes.push(i)},Re=function(t,r){if(t instanceof Error)return this.errorHandler(t,r);throw t},Fe=function(t,r,a,s){if(s==="HEAD")return(async()=>new Response(null,await b(this,k,Fe).call(this,t,r,a,"GET")))();const i=this.getPath(t,{env:a}),n=this.router.match(s,i),l=new qt(t,{path:i,matchResult:n,env:a,executionCtx:r,notFoundHandler:o(this,z)});if(n[0].length===1){let d;try{d=n[0][0][0][0](l,async()=>{l.res=await o(this,z).call(this,l)})}catch(p){return b(this,k,Re).call(this,p,l)}return d instanceof Promise?d.then(p=>p||(l.finalized?l.res:o(this,z).call(this,l))).catch(p=>b(this,k,Re).call(this,p,l)):d??o(this,z).call(this,l)}const c=Ve(n[0],this.errorHandler,o(this,z));return(async()=>{try{const d=await c(l);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return b(this,k,Re).call(this,d,l)}})()},fe),xt=[];function Jt(e,t){const r=this.buildAllMatchers(),a=((s,i)=>{const n=r[s]||r[w],l=n[2][i];if(l)return l;const c=i.match(n[0]);if(!c)return[[],xt];const d=c.indexOf("",1);return[n[1][d],c]});return this.match=a,a(e,t)}var Le="[^/]+",ye=".*",we="(?:|/.*)",ne=Symbol(),Xt=new Set(".\\+*[^]$()");function Qt(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===ye||e===we?1:t===ye||t===we?-1:e===Le?1:t===Le?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var Q,Z,R,re,Zt=(re=class{constructor(){u(this,Q);u(this,Z);u(this,R,Object.create(null))}insert(t,r,a,s,i){if(t.length===0){if(o(this,Q)!==void 0)throw ne;if(i)return;m(this,Q,r);return}const[n,...l]=t,c=n==="*"?l.length===0?["","",ye]:["","",Le]:n==="/*"?["","",we]:n.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(c){const p=c[1];let f=c[2]||Le;if(p&&c[2]&&(f===".*"||(f=f.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(f))))throw ne;if(d=o(this,R)[f],!d){if(Object.keys(o(this,R)).some(g=>g!==ye&&g!==we))throw ne;if(i)return;d=o(this,R)[f]=new re,p!==""&&m(d,Z,s.varIndex++)}!i&&p!==""&&a.push([p,o(d,Z)])}else if(d=o(this,R)[n],!d){if(Object.keys(o(this,R)).some(p=>p.length>1&&p!==ye&&p!==we))throw ne;if(i)return;d=o(this,R)[n]=new re}d.insert(l,r,a,s,i)}buildRegExpStr(){const r=Object.keys(o(this,R)).sort(Qt).map(a=>{const s=o(this,R)[a];return(typeof o(s,Z)=="number"?`(${a})@${o(s,Z)}`:Xt.has(a)?`\\${a}`:a)+s.buildRegExpStr()});return typeof o(this,Q)=="number"&&r.unshift(`#${o(this,Q)}`),r.length===0?"":r.length===1?r[0]:"(?:"+r.join("|")+")"}},Q=new WeakMap,Z=new WeakMap,R=new WeakMap,re),Ie,Ae,rt,er=(rt=class{constructor(){u(this,Ie,{varIndex:0});u(this,Ae,new Zt)}insert(e,t,r){const a=[],s=[];for(let n=0;;){let l=!1;if(e=e.replace(/\{[^}]+\}/g,c=>{const d=`@\\${n}`;return s[n]=[d,c],n++,l=!0,d}),!l)break}const i=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let n=s.length-1;n>=0;n--){const[l]=s[n];for(let c=i.length-1;c>=0;c--)if(i[c].indexOf(l)!==-1){i[c]=i[c].replace(l,s[n][1]);break}}return o(this,Ae).insert(i,t,a,o(this,Ie),r),a}buildRegExp(){let e=o(this,Ae).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const r=[],a=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(s,i,n)=>i!==void 0?(r[++t]=Number(i),"$()"):(n!==void 0&&(a[Number(n)]=++t),"")),[new RegExp(`^${e}`),r,a]}},Ie=new WeakMap,Ae=new WeakMap,rt),tr=[/^$/,[],Object.create(null)],Pe=Object.create(null);function yt(e){return Pe[e]??(Pe[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,r)=>r?`\\${r}`:"(?:|/.*)")}$`))}function rr(){Pe=Object.create(null)}function ar(e){var d;const t=new er,r=[];if(e.length===0)return tr;const a=e.map(p=>[!/\*|\/:/.test(p[0]),...p]).sort(([p,f],[g,x])=>p?1:g?-1:f.length-x.length),s=Object.create(null);for(let p=0,f=-1,g=a.length;p<g;p++){const[x,v,E]=a[p];x?s[v]=[E.map(([C])=>[C,Object.create(null)]),xt]:f++;let j;try{j=t.insert(v,f,x)}catch(C){throw C===ne?new vt(v):C}x||(r[f]=E.map(([C,y])=>{const F=Object.create(null);for(y-=1;y>=0;y--){const[ue,He]=j[y];F[ue]=He}return[C,F]}))}const[i,n,l]=t.buildRegExp();for(let p=0,f=r.length;p<f;p++)for(let g=0,x=r[p].length;g<x;g++){const v=(d=r[p][g])==null?void 0:d[1];if(!v)continue;const E=Object.keys(v);for(let j=0,C=E.length;j<C;j++)v[E[j]]=l[v[E[j]]]}const c=[];for(const p in n)c[p]=r[n[p]];return[i,c,s]}function ie(e,t){if(e){for(const r of Object.keys(e).sort((a,s)=>s.length-a.length))if(yt(r).test(t))return[...e[r]]}}var G,q,De,wt,at,sr=(at=class{constructor(){u(this,De);h(this,"name","RegExpRouter");u(this,G);u(this,q);h(this,"match",Jt);m(this,G,{[w]:Object.create(null)}),m(this,q,{[w]:Object.create(null)})}add(e,t,r){var l;const a=o(this,G),s=o(this,q);if(!a||!s)throw new Error(gt);a[e]||[a,s].forEach(c=>{c[e]=Object.create(null),Object.keys(c[w]).forEach(d=>{c[e][d]=[...c[w][d]]})}),t==="/*"&&(t="*");const i=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const c=yt(t);e===w?Object.keys(a).forEach(d=>{var p;(p=a[d])[t]||(p[t]=ie(a[d],t)||ie(a[w],t)||[])}):(l=a[e])[t]||(l[t]=ie(a[e],t)||ie(a[w],t)||[]),Object.keys(a).forEach(d=>{(e===w||e===d)&&Object.keys(a[d]).forEach(p=>{c.test(p)&&a[d][p].push([r,i])})}),Object.keys(s).forEach(d=>{(e===w||e===d)&&Object.keys(s[d]).forEach(p=>c.test(p)&&s[d][p].push([r,i]))});return}const n=ct(t)||[t];for(let c=0,d=n.length;c<d;c++){const p=n[c];Object.keys(s).forEach(f=>{var g;(e===w||e===f)&&((g=s[f])[p]||(g[p]=[...ie(a[f],p)||ie(a[w],p)||[]]),s[f][p].push([r,i-d+c+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(o(this,q)).concat(Object.keys(o(this,G))).forEach(t=>{e[t]||(e[t]=b(this,De,wt).call(this,t))}),m(this,G,m(this,q,void 0)),rr(),e}},G=new WeakMap,q=new WeakMap,De=new WeakSet,wt=function(e){const t=[];let r=e===w;return[o(this,G),o(this,q)].forEach(a=>{const s=a[e]?Object.keys(a[e]).map(i=>[i,a[e][i]]):[];s.length!==0?(r||(r=!0),t.push(...s)):e!==w&&t.push(...Object.keys(a[w]).map(i=>[i,a[w][i]]))}),r?ar(t):null},at),_,H,st,ir=(st=class{constructor(e){h(this,"name","SmartRouter");u(this,_,[]);u(this,H,[]);m(this,_,e.routers)}add(e,t,r){if(!o(this,H))throw new Error(gt);o(this,H).push([e,t,r])}match(e,t){if(!o(this,H))throw new Error("Fatal error");const r=o(this,_),a=o(this,H),s=r.length;let i=0,n;for(;i<s;i++){const l=r[i];try{for(let c=0,d=a.length;c<d;c++)l.add(...a[c]);n=l.match(e,t)}catch(c){if(c instanceof vt)continue;throw c}this.match=l.match.bind(l),m(this,_,[l]),m(this,H,void 0);break}if(i===s)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,n}get activeRouter(){if(o(this,H)||o(this,_).length!==1)throw new Error("No active router has been determined yet.");return o(this,_)[0]}},_=new WeakMap,H=new WeakMap,st),xe=Object.create(null),or=e=>{for(const t in e)return!0;return!1},U,S,ee,me,B,N,J,he,nr=(he=class{constructor(t,r,a){u(this,N);u(this,U);u(this,S);u(this,ee);u(this,me,0);u(this,B,xe);if(m(this,S,a||Object.create(null)),m(this,U,[]),t&&r){const s=Object.create(null);s[t]={handler:r,possibleKeys:[],score:0},m(this,U,[s])}m(this,ee,[])}insert(t,r,a){m(this,me,++Ke(this,me)._);let s=this;const i=Lt(r),n=[];for(let l=0,c=i.length;l<c;l++){const d=i[l],p=i[l+1],f=Ht(d,p),g=Array.isArray(f)?f[0]:d;if(g in o(s,S)){s=o(s,S)[g],f&&n.push(f[1]);continue}o(s,S)[g]=new he,f&&(o(s,ee).push(f),n.push(f[1])),s=o(s,S)[g]}return o(s,U).push({[t]:{handler:a,possibleKeys:n.filter((l,c,d)=>d.indexOf(l)===c),score:o(this,me)}}),s}search(t,r){var p;const a=[];m(this,B,xe);let i=[this];const n=ot(r),l=[],c=n.length;let d=null;for(let f=0;f<c;f++){const g=n[f],x=f===c-1,v=[];for(let j=0,C=i.length;j<C;j++){const y=i[j],F=o(y,S)[g];F&&(m(F,B,o(y,B)),x?(o(F,S)["*"]&&b(this,N,J).call(this,a,o(F,S)["*"],t,o(y,B)),b(this,N,J).call(this,a,F,t,o(y,B))):v.push(F));for(let ue=0,He=o(y,ee).length;ue<He;ue++){const _e=o(y,ee)[ue],$=o(y,B)===xe?{}:{...o(y,B)};if(_e==="*"){const ae=o(y,S)["*"];ae&&(b(this,N,J).call(this,a,ae,t,o(y,B)),m(ae,B,$),v.push(ae));continue}const[St,Ue,ge]=_e;if(!g&&!(ge instanceof RegExp))continue;const P=o(y,S)[St];if(ge instanceof RegExp){if(d===null){d=new Array(c);let se=r[0]==="/"?1:0;for(let ve=0;ve<c;ve++)d[ve]=se,se+=n[ve].length+1}const ae=r.substring(d[f]),Ne=ge.exec(ae);if(Ne){if($[Ue]=Ne[0],b(this,N,J).call(this,a,P,t,o(y,B),$),or(o(P,S))){m(P,B,$);const se=((p=Ne[0].match(/\//))==null?void 0:p.length)??0;(l[se]||(l[se]=[])).push(P)}continue}}(ge===!0||ge.test(g))&&($[Ue]=g,x?(b(this,N,J).call(this,a,P,t,$,o(y,B)),o(P,S)["*"]&&b(this,N,J).call(this,a,o(P,S)["*"],t,$,o(y,B))):(m(P,B,$),v.push(P)))}}const E=l.shift();i=E?v.concat(E):v}return a.length>1&&a.sort((f,g)=>f.score-g.score),[a.map(({handler:f,params:g})=>[f,g])]}},U=new WeakMap,S=new WeakMap,ee=new WeakMap,me=new WeakMap,B=new WeakMap,N=new WeakSet,J=function(t,r,a,s,i){for(let n=0,l=o(r,U).length;n<l;n++){const c=o(r,U)[n],d=c[a]||c[w],p={};if(d!==void 0&&(d.params=Object.create(null),t.push(d),s!==xe||i&&i!==xe))for(let f=0,g=d.possibleKeys.length;f<g;f++){const x=d.possibleKeys[f],v=p[d.score];d.params[x]=i!=null&&i[x]&&!v?i[x]:s[x]??(i==null?void 0:i[x]),p[d.score]=!0}}},he),te,it,lr=(it=class{constructor(){h(this,"name","TrieRouter");u(this,te);m(this,te,new nr)}add(e,t,r){const a=ct(t);if(a){for(let s=0,i=a.length;s<i;s++)o(this,te).insert(e,a[s],r);return}o(this,te).insert(e,t,r)}match(e,t){return o(this,te).search(e,t)}},te=new WeakMap,it),kt=class extends Vt{constructor(e={}){super(e),this.router=e.router??new ir({routers:[new sr,new lr]})}},cr=/^\s*(?:text\/(?!event-stream(?:[;\s]|$))[^;\s]+|application\/(?:javascript|json|xml|xml-dtd|ecmascript|dart|msgpack|postscript|rtf|tar|toml|vnd\.dart|vnd\.ms-fontobject|vnd\.ms-opentype|vnd\.msgpack|wasm|x-httpd-php|x-javascript|x-msgpack|x-ns-proxy-autoconfig|x-sh|x-tar|x-virtualbox-hdd|x-virtualbox-ova|x-virtualbox-ovf|x-virtualbox-vbox|x-virtualbox-vdi|x-virtualbox-vhd|x-virtualbox-vmdk|x-www-form-urlencoded)|font\/(?:otf|ttf)|image\/(?:bmp|vnd\.adobe\.photoshop|vnd\.microsoft\.icon|vnd\.ms-dds|x-icon|x-ms-bmp)|message\/rfc822|model\/gltf-binary|x-shader\/x-fragment|x-shader\/x-vertex|[^;\s]+?\+(?:json|text|xml|yaml|msgpack))(?:[;\s]|$)/i,Qe=(e,t=pr)=>{const r=/\.([a-zA-Z0-9]+?)$/,a=e.match(r);if(a)return t[a[1].toLowerCase()]},dr={aac:"audio/aac",avi:"video/x-msvideo",avif:"image/avif",av1:"video/av1",bin:"application/octet-stream",bmp:"image/bmp",css:"text/css; charset=utf-8",csv:"text/csv; charset=utf-8",eot:"application/vnd.ms-fontobject",epub:"application/epub+zip",gif:"image/gif",gz:"application/gzip",htm:"text/html; charset=utf-8",html:"text/html; charset=utf-8",ico:"image/x-icon",ics:"text/calendar; charset=utf-8",jpeg:"image/jpeg",jpg:"image/jpeg",js:"text/javascript; charset=utf-8",json:"application/json",jsonld:"application/ld+json",map:"application/json",mid:"audio/x-midi",midi:"audio/x-midi",mjs:"text/javascript; charset=utf-8",mp3:"audio/mpeg",mp4:"video/mp4",mpeg:"video/mpeg",oga:"audio/ogg",ogv:"video/ogg",ogx:"application/ogg",opus:"audio/opus",otf:"font/otf",pdf:"application/pdf",png:"image/png",rtf:"application/rtf",svg:"image/svg+xml; charset=utf-8",tif:"image/tiff",tiff:"image/tiff",ts:"video/mp2t",ttf:"font/ttf",txt:"text/plain; charset=utf-8",wasm:"application/wasm",webm:"video/webm",weba:"audio/webm",webmanifest:"application/manifest+json",webp:"image/webp",woff:"font/woff",woff2:"font/woff2",xhtml:"application/xhtml+xml; charset=utf-8",xml:"application/xml; charset=utf-8",zip:"application/zip","3gp":"video/3gpp","3g2":"video/3gpp2",gltf:"model/gltf+json",glb:"model/gltf-binary"},pr=dr,fr=(...e)=>{let t=e.filter(s=>s!=="").join("/");t=t.replace(new RegExp("(?<=\\/)\\/+","g"),"");const r=t.split("/"),a=[];for(const s of r)s===".."&&a.length>0&&a.at(-1)!==".."?a.pop():s!=="."&&a.push(s);return a.join("/")||"."},Et={br:".br",zstd:".zst",gzip:".gz"},mr=Object.keys(Et),hr="index.html",ur=e=>{const t=e.root??"./",r=e.path,a=e.join??fr;return async(s,i)=>{var p,f,g,x;if(s.finalized)return i();let n;if(e.path)n=e.path;else try{if(n=nt(s.req.path),/(?:^|[\/\\])\.{1,2}(?:$|[\/\\])|[\/\\]{2,}/.test(n))throw new Error}catch{return await((p=e.onNotFound)==null?void 0:p.call(e,s.req.path,s)),i()}let l=a(t,!r&&e.rewriteRequestPath?e.rewriteRequestPath(n):n);e.isDir&&await e.isDir(l)&&(l=a(l,hr));const c=e.getContent;let d=await c(l,s);if(d instanceof Response)return s.newResponse(d.body,d);if(d){const v=e.mimes&&Qe(l,e.mimes)||Qe(l);if(s.header("Content-Type",v||"application/octet-stream"),e.precompressed&&(!v||cr.test(v))){const E=new Set((f=s.req.header("Accept-Encoding"))==null?void 0:f.split(",").map(j=>j.trim()));for(const j of mr){if(!E.has(j))continue;const C=await c(l+Et[j],s);if(C){d=C,s.header("Content-Encoding",j),s.header("Vary","Accept-Encoding",{append:!0});break}}}return await((g=e.onFound)==null?void 0:g.call(e,l,s)),s.body(d)}await((x=e.onNotFound)==null?void 0:x.call(e,l,s)),await i()}},gr=async(e,t)=>{let r;t&&t.manifest?typeof t.manifest=="string"?r=JSON.parse(t.manifest):r=t.manifest:typeof __STATIC_CONTENT_MANIFEST=="string"?r=JSON.parse(__STATIC_CONTENT_MANIFEST):r=__STATIC_CONTENT_MANIFEST;let a;t&&t.namespace?a=t.namespace:a=__STATIC_CONTENT;const s=r[e];if(!s)return null;const i=await a.get(s,{type:"stream"});return i||null},vr=(e={})=>async function(r,a){return ur({...e,getContent:async i=>gr(i,{manifest:e.manifest,namespace:e.namespace?e.namespace:r.env?r.env.__STATIC_CONTENT:void 0})})(r,a)},br=e=>vr(e);const Y=new kt;Y.use("/static/*",br({root:"./public"}));Y.get("/",e=>e.html(xr()));Y.get("/about",e=>e.html(yr()));Y.get("/projects",e=>e.html(jt()));Y.get("/projects/:slug",e=>{const t=e.req.param("slug"),r=kr(t);return r?e.html(r):e.html(jt())});Y.get("/contact",e=>e.html(Er()));Y.post("/api/contact",async e=>{var g;const t=await e.req.json(),{firstName:r,lastName:a,company:s,email:i,phone:n,projectType:l,units:c,message:d}=t,p=((g=e.env)==null?void 0:g.RESEND_API_KEY)||"re_cUWsgWQS_ADvgH3quA64U1cpoVRqAo4CQ",f=`
...
${Oe()}`}const Ze=new kt,jr=Object.assign({"/src/index.tsx":Y});let Bt=!1;for(const[,e]of Object.entries(jr))e&&(Ze.all("*",t=>{let r;try{r=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,r)}),Ze.notFound(t=>{let r;try{r=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,r)}),Bt=!0);if(!Bt)throw new Error("Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']");export{Ze as default};
