var Bt=Object.defineProperty;var Ue=e=>{throw TypeError(e)};var Ct=(e,t,r)=>t in e?Bt(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var u=(e,t,r)=>Ct(e,typeof t!="symbol"?t+"":t,r),Ne=(e,t,r)=>t.has(e)||Ue("Cannot "+r);var o=(e,t,r)=>(Ne(e,t,"read from private field"),r?r.call(e):t.get(e)),h=(e,t,r)=>t.has(e)?Ue("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),m=(e,t,r,a)=>(Ne(e,t,"write to private field"),a?a.call(e,r):t.set(e,r),r),b=(e,t,r)=>(Ne(e,t,"access private method"),r);var Ye=(e,t,r,a)=>({set _(s){m(e,t,s,r)},get _(){return o(e,t,a)}});var Ve=(e,t,r)=>(a,s)=>{let i=-1;return n(0);async function n(l){if(l<=i)throw new Error("next() called multiple times");i=l;let c,d=!1,p;if(e[l]?(p=e[l][0][0],a.req.routeIndex=l):p=l===e.length&&s||void 0,p)try{c=await p(a,()=>n(l+1))}catch(f){if(f instanceof Error&&t)a.error=f,c=await t(f,a),d=!0;else throw f}else a.finalized===!1&&r&&(c=await r(a));return c&&(a.finalized===!1||d)&&(a.res=c),a}},Rt=Symbol(),Tt=async(e,t=Object.create(null))=>{const{all:r=!1,dot:a=!1}=t,i=(e instanceof ft?e.raw.headers:e.headers).get("Content-Type");return i!=null&&i.startsWith("multipart/form-data")||i!=null&&i.startsWith("application/x-www-form-urlencoded")?Ot(e,{all:r,dot:a}):{}};async function Ot(e,t){const r=await e.formData();return r?zt(r,t):{}}function zt(e,t){const r=Object.create(null);return e.forEach((a,s)=>{t.all||s.endsWith("[]")?Pt(r,s,a):r[s]=a}),t.dot&&Object.entries(r).forEach(([a,s])=>{a.includes(".")&&(Ft(r,a,s),delete r[a])}),r}var Pt=(e,t,r)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(r):e[t]=[e[t],r]:t.endsWith("[]")?e[t]=[r]:e[t]=r},Ft=(e,t,r)=>{if(/(?:^|\.)__proto__\./.test(t))return;let a=e;const s=t.split(".");s.forEach((i,n)=>{n===s.length-1?a[i]=r:((!a[i]||typeof a[i]!="object"||Array.isArray(a[i])||a[i]instanceof File)&&(a[i]=Object.create(null)),a=a[i])})},ot=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},Lt=e=>{const{groups:t,path:r}=It(e),a=ot(r);return Dt(a,t)},It=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(r,a)=>{const s=`@${a}`;return t.push([s,r]),s}),{groups:t,path:e}},Dt=(e,t)=>{for(let r=t.length-1;r>=0;r--){const[a]=t[r];for(let s=e.length-1;s>=0;s--)if(e[s].includes(a)){e[s]=e[s].replace(a,t[r][1]);break}}return e},Oe={},$t=(e,t)=>{if(e==="*")return"*";const r=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(r){const a=`${e}#${t}`;return Oe[a]||(r[2]?Oe[a]=t&&t[0]!==":"&&t[0]!=="*"?[a,r[1],new RegExp(`^${r[2]}(?=/${t})`)]:[e,r[1],new RegExp(`^${r[2]}$`)]:Oe[a]=[e,r[1],!0]),Oe[a]}return null},_e=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,r=>{try{return t(r)}catch{return r}})}},nt=e=>_e(e,decodeURI),lt=e=>{const t=e.url,r=t.indexOf("/",t.indexOf(":")+4);let a=r;for(;a<t.length;a++){const s=t.charCodeAt(a);if(s===37){const i=t.indexOf("?",a),n=t.indexOf("#",a),l=i===-1?n===-1?void 0:n:n===-1?i:Math.min(i,n),c=t.slice(r,l);return nt(c.includes("%25")?c.replace(/%25/g,"%2525"):c)}else if(s===63||s===35)break}return t.slice(r,a)},Ht=e=>{const t=lt(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Y=(e,t,...r)=>(r.length&&(t=Y(t,...r)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),ct=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),r=[];let a="";return t.forEach(s=>{if(s!==""&&!/\:/.test(s))a+="/"+s;else if(/\:/.test(s))if(/\?/.test(s)){r.length===0&&a===""?r.push("/"):r.push(a);const i=s.replace("?","");a+="/"+i,r.push(a)}else a+="/"+s}),r.filter((s,i,n)=>n.indexOf(s)===i)},Me=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?_e(e,pt):e):e,dt=(e,t,r)=>{let a;if(!r&&t&&!/[%+]/.test(t)){let n=e.indexOf("?",8);if(n===-1)return;for(e.startsWith(t,n+1)||(n=e.indexOf(`&${t}`,n+1));n!==-1;){const l=e.charCodeAt(n+t.length+1);if(l===61){const c=n+t.length+2,d=e.indexOf("&",c);return Me(e.slice(c,d===-1?void 0:d))}else if(l==38||isNaN(l))return"";n=e.indexOf(`&${t}`,n+1)}if(a=/[%+]/.test(e),!a)return}const s={};a??(a=/[%+]/.test(e));let i=e.indexOf("?",8);for(;i!==-1;){const n=e.indexOf("&",i+1);let l=e.indexOf("=",i);l>n&&n!==-1&&(l=-1);let c=e.slice(i+1,l===-1?n===-1?void 0:n:l);if(a&&(c=Me(c)),i=n,c==="")continue;let d;l===-1?d="":(d=e.slice(l+1,n===-1?void 0:n),a&&(d=Me(d))),r?(s[c]&&Array.isArray(s[c])||(s[c]=[]),s[c].push(d)):s[c]??(s[c]=d)}return t?s[t]:s},Nt=dt,Mt=(e,t)=>dt(e,t,!0),pt=decodeURIComponent,Je=e=>_e(e,pt),le,R,N,mt,ut,qe,L,et,ft=(et=class{constructor(e,t="/",r=[[]]){h(this,N);u(this,"raw");h(this,le);h(this,R);u(this,"routeIndex",0);u(this,"path");u(this,"bodyCache",{});h(this,L,e=>{const{bodyCache:t,raw:r}=this,a=t[e];if(a)return a;const s=Object.keys(t)[0];return s?t[s].then(i=>(s==="json"&&(i=JSON.stringify(i)),new Response(i)[e]())):t[e]=r[e]()});this.raw=e,this.path=t,m(this,R,r),m(this,le,{})}param(e){return e?b(this,N,mt).call(this,e):b(this,N,ut).call(this)}query(e){return Nt(this.url,e)}queries(e){return Mt(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((r,a)=>{t[a]=r}),t}async parseBody(e){return Tt(this,e)}json(){return o(this,L).call(this,"text").then(e=>JSON.parse(e))}text(){return o(this,L).call(this,"text")}arrayBuffer(){return o(this,L).call(this,"arrayBuffer")}bytes(){return o(this,L).call(this,"arrayBuffer").then(e=>new Uint8Array(e))}blob(){return o(this,L).call(this,"blob")}formData(){return o(this,L).call(this,"formData")}addValidatedData(e,t){o(this,le)[e]=t}valid(e){return o(this,le)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Rt](){return o(this,R)}get matchedRoutes(){return o(this,R)[0].map(([[,e]])=>e)}get routePath(){return o(this,R)[0].map(([[,e]])=>e)[this.routeIndex].path}},le=new WeakMap,R=new WeakMap,N=new WeakSet,mt=function(e){const t=o(this,R)[0][this.routeIndex][1][e],r=b(this,N,qe).call(this,t);return r&&/\%/.test(r)?Je(r):r},ut=function(){const e={},t=Object.keys(o(this,R)[0][this.routeIndex][1]);for(const r of t){const a=b(this,N,qe).call(this,o(this,R)[0][this.routeIndex][1][r]);a!==void 0&&(e[r]=/\%/.test(a)?Je(a):a)}return e},qe=function(e){return o(this,R)[1]?o(this,R)[1][e]:e},L=new WeakMap,et),Wt={Stringify:1},ht=async(e,t,r,a,s)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const i=e.callbacks;return i!=null&&i.length?(s?s[0]+=e:s=[e],Promise.all(i.map(l=>l({phase:t,buffer:s,context:a}))).then(l=>Promise.all(l.filter(Boolean).map(c=>ht(c,t,!1,a,s))).then(()=>s[0]))):Promise.resolve(e)},qt="text/plain; charset=UTF-8",We=(e,t)=>({"Content-Type":e,...t}),be=(e,t)=>new Response(e,t),ke,Ee,I,ce,D,B,je,de,pe,X,Se,Ae,W,oe,tt,_t=(tt=class{constructor(e,t){h(this,W);h(this,ke);h(this,Ee);u(this,"env",{});h(this,I);u(this,"finalized",!1);u(this,"error");h(this,ce);h(this,D);h(this,B);h(this,je);h(this,de);h(this,pe);h(this,X);h(this,Se);h(this,Ae);u(this,"render",(...e)=>(o(this,de)??m(this,de,t=>this.html(t)),o(this,de).call(this,...e)));u(this,"setLayout",e=>m(this,je,e));u(this,"getLayout",()=>o(this,je));u(this,"setRenderer",e=>{m(this,de,e)});u(this,"header",(e,t,r)=>{this.finalized&&m(this,B,be(o(this,B).body,o(this,B)));const a=o(this,B)?o(this,B).headers:o(this,X)??m(this,X,new Headers);t===void 0?a.delete(e):r!=null&&r.append?a.append(e,t):a.set(e,t)});u(this,"status",e=>{m(this,ce,e)});u(this,"set",(e,t)=>{o(this,I)??m(this,I,new Map),o(this,I).set(e,t)});u(this,"get",e=>o(this,I)?o(this,I).get(e):void 0);u(this,"newResponse",(...e)=>b(this,W,oe).call(this,...e));u(this,"body",(e,t,r)=>b(this,W,oe).call(this,e,t,r));u(this,"text",(e,t,r)=>!o(this,X)&&!o(this,ce)&&!t&&!r&&!this.finalized?new Response(e):b(this,W,oe).call(this,e,t,We(qt,r)));u(this,"json",(e,t,r)=>b(this,W,oe).call(this,JSON.stringify(e),t,We("application/json",r)));u(this,"html",(e,t,r)=>{const a=s=>b(this,W,oe).call(this,s,t,We("text/html; charset=UTF-8",r));return typeof e=="object"?ht(e,Wt.Stringify,!1,{}).then(a):a(e)});u(this,"redirect",(e,t)=>{const r=String(e);return this.header("Location",/[^\x00-\xFF]/.test(r)?encodeURI(r):r),this.newResponse(null,t??302)});u(this,"notFound",()=>(o(this,pe)??m(this,pe,()=>be()),o(this,pe).call(this,this)));m(this,ke,e),t&&(m(this,D,t.executionCtx),this.env=t.env,m(this,pe,t.notFoundHandler),m(this,Ae,t.path),m(this,Se,t.matchResult))}get req(){return o(this,Ee)??m(this,Ee,new ft(o(this,ke),o(this,Ae),o(this,Se))),o(this,Ee)}get event(){if(o(this,D)&&"respondWith"in o(this,D))return o(this,D);throw Error("This context has no FetchEvent")}get executionCtx(){if(o(this,D))return o(this,D);throw Error("This context has no ExecutionContext")}get res(){return o(this,B)||m(this,B,be(null,{headers:o(this,X)??m(this,X,new Headers)}))}set res(e){if(o(this,B)&&e){e=be(e.body,e);for(const[t,r]of o(this,B).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const a=o(this,B).headers.getSetCookie();e.headers.delete("set-cookie");for(const s of a)e.headers.append("set-cookie",s)}else e.headers.set(t,r)}m(this,B,e),this.finalized=!0}get var(){return o(this,I)?Object.fromEntries(o(this,I)):{}}},ke=new WeakMap,Ee=new WeakMap,I=new WeakMap,ce=new WeakMap,D=new WeakMap,B=new WeakMap,je=new WeakMap,de=new WeakMap,pe=new WeakMap,X=new WeakMap,Se=new WeakMap,Ae=new WeakMap,W=new WeakSet,oe=function(e,t,r){const a=o(this,B)?new Headers(o(this,B).headers):o(this,X)??new Headers;if(typeof t=="object"&&"headers"in t){const i=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[n,l]of i)n.toLowerCase()==="set-cookie"?a.append(n,l):a.set(n,l)}if(r)for(const[i,n]of Object.entries(r))if(typeof n=="string")a.set(i,n);else{a.delete(i);for(const l of n)a.append(i,l)}const s=typeof t=="number"?t:(t==null?void 0:t.status)??o(this,ce);return be(e,{status:s,headers:a})},tt),w="ALL",Gt="all",Kt=["get","post","put","delete","options","patch"],gt="Can not add a route since the matcher is already built.",vt=class extends Error{},Ut="__COMPOSED_HANDLER",Yt=e=>e.text("404 Not Found",404),Xe=(e,t)=>{if("getResponse"in e){const r=e.getResponse();return t.newResponse(r.body,r)}return console.error(e),t.text("Internal Server Error",500)},T,k,bt,O,V,ze,Pe,fe,Vt=(fe=class{constructor(t={}){h(this,k);u(this,"get");u(this,"post");u(this,"put");u(this,"delete");u(this,"options");u(this,"patch");u(this,"all");u(this,"on");u(this,"use");u(this,"router");u(this,"getPath");u(this,"_basePath","/");h(this,T,"/");u(this,"routes",[]);h(this,O,Yt);u(this,"errorHandler",Xe);u(this,"onError",t=>(this.errorHandler=t,this));u(this,"notFound",t=>(m(this,O,t),this));u(this,"fetch",(t,...r)=>b(this,k,Pe).call(this,t,r[1],r[0],t.method));u(this,"request",(t,r,a,s)=>t instanceof Request?this.fetch(r?new Request(t,r):t,a,s):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Y("/",t)}`,r),a,s)));u(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(b(this,k,Pe).call(this,t.request,t,void 0,t.request.method))})});[...Kt,Gt].forEach(i=>{this[i]=(n,...l)=>(typeof n=="string"?m(this,T,n):b(this,k,V).call(this,i,o(this,T),n),l.forEach(c=>{b(this,k,V).call(this,i,o(this,T),c)}),this)}),this.on=(i,n,...l)=>{for(const c of[n].flat()){m(this,T,c);for(const d of[i].flat())l.map(p=>{b(this,k,V).call(this,d.toUpperCase(),o(this,T),p)})}return this},this.use=(i,...n)=>(typeof i=="string"?m(this,T,i):(m(this,T,"*"),n.unshift(i)),n.forEach(l=>{b(this,k,V).call(this,w,o(this,T),l)}),this);const{strict:a,...s}=t;Object.assign(this,s),this.getPath=a??!0?t.getPath??lt:Ht}route(t,r){const a=this.basePath(t);return r.routes.map(s=>{var n;let i;r.errorHandler===Xe?i=s.handler:(i=async(l,c)=>(await Ve([],r.errorHandler)(l,()=>s.handler(l,c))).res,i[Ut]=s.handler),b(n=a,k,V).call(n,s.method,s.path,i,s.basePath)}),this}basePath(t){const r=b(this,k,bt).call(this);return r._basePath=Y(this._basePath,t),r}mount(t,r,a){let s,i;a&&(typeof a=="function"?i=a:(i=a.optionHandler,a.replaceRequest===!1?s=c=>c:s=a.replaceRequest));const n=i?c=>{const d=i(c);return Array.isArray(d)?d:[d]}:c=>{let d;try{d=c.executionCtx}catch{}return[c.env,d]};s||(s=(()=>{const c=Y(this._basePath,t),d=c==="/"?0:c.length;return p=>{const f=new URL(p.url);return f.pathname=this.getPath(p).slice(d)||"/",new Request(f,p)}})());const l=async(c,d)=>{const p=await r(s(c.req.raw),...n(c));if(p)return p;await d()};return b(this,k,V).call(this,w,Y(t,"*"),l),this}},T=new WeakMap,k=new WeakSet,bt=function(){const t=new fe({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,m(t,O,o(this,O)),t.routes=this.routes,t},O=new WeakMap,V=function(t,r,a,s){t=t.toUpperCase(),r=Y(this._basePath,r);const i={basePath:s!==void 0?Y(this._basePath,s):this._basePath,path:r,method:t,handler:a};this.router.add(t,r,[a,i]),this.routes.push(i)},ze=function(t,r){if(t instanceof Error)return this.errorHandler(t,r);throw t},Pe=function(t,r,a,s){if(s==="HEAD")return(async()=>new Response(null,await b(this,k,Pe).call(this,t,r,a,"GET")))();const i=this.getPath(t,{env:a}),n=this.router.match(s,i),l=new _t(t,{path:i,matchResult:n,env:a,executionCtx:r,notFoundHandler:o(this,O)});if(n[0].length===1){let d;try{d=n[0][0][0][0](l,async()=>{l.res=await o(this,O).call(this,l)})}catch(p){return b(this,k,ze).call(this,p,l)}return d instanceof Promise?d.then(p=>p||(l.finalized?l.res:o(this,O).call(this,l))).catch(p=>b(this,k,ze).call(this,p,l)):d??o(this,O).call(this,l)}const c=Ve(n[0],this.errorHandler,o(this,O));return(async()=>{try{const d=await c(l);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return b(this,k,ze).call(this,d,l)}})()},fe),yt=[];function Jt(e,t){const r=this.buildAllMatchers(),a=((s,i)=>{const n=r[s]||r[w],l=n[2][i];if(l)return l;const c=i.match(n[0]);if(!c)return[[],yt];const d=c.indexOf("",1);return[n[1][d],c]});return this.match=a,a(e,t)}var Le="[^/]+",xe=".*",we="(?:|/.*)",ne=Symbol(),Xt=new Set(".\\+*[^]$()");function Qt(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===xe||e===we?1:t===xe||t===we?-1:e===Le?1:t===Le?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var Q,Z,z,re,Zt=(re=class{constructor(){h(this,Q);h(this,Z);h(this,z,Object.create(null))}insert(t,r,a,s,i){if(t.length===0){if(o(this,Q)!==void 0)throw ne;if(i)return;m(this,Q,r);return}const[n,...l]=t,c=n==="*"?l.length===0?["","",xe]:["","",Le]:n==="/*"?["","",we]:n.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(c){const p=c[1];let f=c[2]||Le;if(p&&c[2]&&(f===".*"||(f=f.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(f))))throw ne;if(d=o(this,z)[f],!d){if(Object.keys(o(this,z)).some(g=>g!==xe&&g!==we))throw ne;if(i)return;d=o(this,z)[f]=new re,p!==""&&m(d,Z,s.varIndex++)}!i&&p!==""&&a.push([p,o(d,Z)])}else if(d=o(this,z)[n],!d){if(Object.keys(o(this,z)).some(p=>p.length>1&&p!==xe&&p!==we))throw ne;if(i)return;d=o(this,z)[n]=new re}d.insert(l,r,a,s,i)}buildRegExpStr(){const r=Object.keys(o(this,z)).sort(Qt).map(a=>{const s=o(this,z)[a];return(typeof o(s,Z)=="number"?`(${a})@${o(s,Z)}`:Xt.has(a)?`\\${a}`:a)+s.buildRegExpStr()});return typeof o(this,Q)=="number"&&r.unshift(`#${o(this,Q)}`),r.length===0?"":r.length===1?r[0]:"(?:"+r.join("|")+")"}},Q=new WeakMap,Z=new WeakMap,z=new WeakMap,re),Ie,Be,rt,er=(rt=class{constructor(){h(this,Ie,{varIndex:0});h(this,Be,new Zt)}insert(e,t,r){const a=[],s=[];for(let n=0;;){let l=!1;if(e=e.replace(/\{[^}]+\}/g,c=>{const d=`@\\${n}`;return s[n]=[d,c],n++,l=!0,d}),!l)break}const i=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let n=s.length-1;n>=0;n--){const[l]=s[n];for(let c=i.length-1;c>=0;c--)if(i[c].indexOf(l)!==-1){i[c]=i[c].replace(l,s[n][1]);break}}return o(this,Be).insert(i,t,a,o(this,Ie),r),a}buildRegExp(){let e=o(this,Be).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const r=[],a=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(s,i,n)=>i!==void 0?(r[++t]=Number(i),"$()"):(n!==void 0&&(a[Number(n)]=++t),"")),[new RegExp(`^${e}`),r,a]}},Ie=new WeakMap,Be=new WeakMap,rt),tr=[/^$/,[],Object.create(null)],Fe=Object.create(null);function xt(e){return Fe[e]??(Fe[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,r)=>r?`\\${r}`:"(?:|/.*)")}$`))}function rr(){Fe=Object.create(null)}function ar(e){var d;const t=new er,r=[];if(e.length===0)return tr;const a=e.map(p=>[!/\*|\/:/.test(p[0]),...p]).sort(([p,f],[g,y])=>p?1:g?-1:f.length-y.length),s=Object.create(null);for(let p=0,f=-1,g=a.length;p<g;p++){const[y,v,E]=a[p];y?s[v]=[E.map(([C])=>[C,Object.create(null)]),yt]:f++;let j;try{j=t.insert(v,f,y)}catch(C){throw C===ne?new vt(v):C}y||(r[f]=E.map(([C,x])=>{const P=Object.create(null);for(x-=1;x>=0;x--){const[he,$e]=j[x];P[he]=$e}return[C,P]}))}const[i,n,l]=t.buildRegExp();for(let p=0,f=r.length;p<f;p++)for(let g=0,y=r[p].length;g<y;g++){const v=(d=r[p][g])==null?void 0:d[1];if(!v)continue;const E=Object.keys(v);for(let j=0,C=E.length;j<C;j++)v[E[j]]=l[v[E[j]]]}const c=[];for(const p in n)c[p]=r[n[p]];return[i,c,s]}function ie(e,t){if(e){for(const r of Object.keys(e).sort((a,s)=>s.length-a.length))if(xt(r).test(t))return[...e[r]]}}var q,_,De,wt,at,sr=(at=class{constructor(){h(this,De);u(this,"name","RegExpRouter");h(this,q);h(this,_);u(this,"match",Jt);m(this,q,{[w]:Object.create(null)}),m(this,_,{[w]:Object.create(null)})}add(e,t,r){var l;const a=o(this,q),s=o(this,_);if(!a||!s)throw new Error(gt);a[e]||[a,s].forEach(c=>{c[e]=Object.create(null),Object.keys(c[w]).forEach(d=>{c[e][d]=[...c[w][d]]})}),t==="/*"&&(t="*");const i=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const c=xt(t);e===w?Object.keys(a).forEach(d=>{var p;(p=a[d])[t]||(p[t]=ie(a[d],t)||ie(a[w],t)||[])}):(l=a[e])[t]||(l[t]=ie(a[e],t)||ie(a[w],t)||[]),Object.keys(a).forEach(d=>{(e===w||e===d)&&Object.keys(a[d]).forEach(p=>{c.test(p)&&a[d][p].push([r,i])})}),Object.keys(s).forEach(d=>{(e===w||e===d)&&Object.keys(s[d]).forEach(p=>c.test(p)&&s[d][p].push([r,i]))});return}const n=ct(t)||[t];for(let c=0,d=n.length;c<d;c++){const p=n[c];Object.keys(s).forEach(f=>{var g;(e===w||e===f)&&((g=s[f])[p]||(g[p]=[...ie(a[f],p)||ie(a[w],p)||[]]),s[f][p].push([r,i-d+c+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(o(this,_)).concat(Object.keys(o(this,q))).forEach(t=>{e[t]||(e[t]=b(this,De,wt).call(this,t))}),m(this,q,m(this,_,void 0)),rr(),e}},q=new WeakMap,_=new WeakMap,De=new WeakSet,wt=function(e){const t=[];let r=e===w;return[o(this,q),o(this,_)].forEach(a=>{const s=a[e]?Object.keys(a[e]).map(i=>[i,a[e][i]]):[];s.length!==0?(r||(r=!0),t.push(...s)):e!==w&&t.push(...Object.keys(a[w]).map(i=>[i,a[w][i]]))}),r?ar(t):null},at),G,$,st,ir=(st=class{constructor(e){u(this,"name","SmartRouter");h(this,G,[]);h(this,$,[]);m(this,G,e.routers)}add(e,t,r){if(!o(this,$))throw new Error(gt);o(this,$).push([e,t,r])}match(e,t){if(!o(this,$))throw new Error("Fatal error");const r=o(this,G),a=o(this,$),s=r.length;let i=0,n;for(;i<s;i++){const l=r[i];try{for(let c=0,d=a.length;c<d;c++)l.add(...a[c]);n=l.match(e,t)}catch(c){if(c instanceof vt)continue;throw c}this.match=l.match.bind(l),m(this,G,[l]),m(this,$,void 0);break}if(i===s)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,n}get activeRouter(){if(o(this,$)||o(this,G).length!==1)throw new Error("No active router has been determined yet.");return o(this,G)[0]}},G=new WeakMap,$=new WeakMap,st),ye=Object.create(null),or=e=>{for(const t in e)return!0;return!1},K,A,ee,me,S,H,J,ue,nr=(ue=class{constructor(t,r,a){h(this,H);h(this,K);h(this,A);h(this,ee);h(this,me,0);h(this,S,ye);if(m(this,A,a||Object.create(null)),m(this,K,[]),t&&r){const s=Object.create(null);s[t]={handler:r,possibleKeys:[],score:0},m(this,K,[s])}m(this,ee,[])}insert(t,r,a){m(this,me,++Ye(this,me)._);let s=this;const i=Lt(r),n=[];for(let l=0,c=i.length;l<c;l++){const d=i[l],p=i[l+1],f=$t(d,p),g=Array.isArray(f)?f[0]:d;if(g in o(s,A)){s=o(s,A)[g],f&&n.push(f[1]);continue}o(s,A)[g]=new ue,f&&(o(s,ee).push(f),n.push(f[1])),s=o(s,A)[g]}return o(s,K).push({[t]:{handler:a,possibleKeys:n.filter((l,c,d)=>d.indexOf(l)===c),score:o(this,me)}}),s}search(t,r){var p;const a=[];m(this,S,ye);let i=[this];const n=ot(r),l=[],c=n.length;let d=null;for(let f=0;f<c;f++){const g=n[f],y=f===c-1,v=[];for(let j=0,C=i.length;j<C;j++){const x=i[j],P=o(x,A)[g];P&&(m(P,S,o(x,S)),y?(o(P,A)["*"]&&b(this,H,J).call(this,a,o(P,A)["*"],t,o(x,S)),b(this,H,J).call(this,a,P,t,o(x,S))):v.push(P));for(let he=0,$e=o(x,ee).length;he<$e;he++){const Ge=o(x,ee)[he],M=o(x,S)===ye?{}:{...o(x,S)};if(Ge==="*"){const ae=o(x,A)["*"];ae&&(b(this,H,J).call(this,a,ae,t,o(x,S)),m(ae,S,M),v.push(ae));continue}const[At,Ke,ge]=Ge;if(!g&&!(ge instanceof RegExp))continue;const F=o(x,A)[At];if(ge instanceof RegExp){if(d===null){d=new Array(c);let se=r[0]==="/"?1:0;for(let ve=0;ve<c;ve++)d[ve]=se,se+=n[ve].length+1}const ae=r.substring(d[f]),He=ge.exec(ae);if(He){if(M[Ke]=He[0],b(this,H,J).call(this,a,F,t,o(x,S),M),or(o(F,A))){m(F,S,M);const se=((p=He[0].match(/\//))==null?void 0:p.length)??0;(l[se]||(l[se]=[])).push(F)}continue}}(ge===!0||ge.test(g))&&(M[Ke]=g,y?(b(this,H,J).call(this,a,F,t,M,o(x,S)),o(F,A)["*"]&&b(this,H,J).call(this,a,o(F,A)["*"],t,M,o(x,S))):(m(F,S,M),v.push(F)))}}const E=l.shift();i=E?v.concat(E):v}return a.length>1&&a.sort((f,g)=>f.score-g.score),[a.map(({handler:f,params:g})=>[f,g])]}},K=new WeakMap,A=new WeakMap,ee=new WeakMap,me=new WeakMap,S=new WeakMap,H=new WeakSet,J=function(t,r,a,s,i){for(let n=0,l=o(r,K).length;n<l;n++){const c=o(r,K)[n],d=c[a]||c[w],p={};if(d!==void 0&&(d.params=Object.create(null),t.push(d),s!==ye||i&&i!==ye))for(let f=0,g=d.possibleKeys.length;f<g;f++){const y=d.possibleKeys[f],v=p[d.score];d.params[y]=i!=null&&i[y]&&!v?i[y]:s[y]??(i==null?void 0:i[y]),p[d.score]=!0}}},ue),te,it,lr=(it=class{constructor(){u(this,"name","TrieRouter");h(this,te);m(this,te,new nr)}add(e,t,r){const a=ct(t);if(a){for(let s=0,i=a.length;s<i;s++)o(this,te).insert(e,a[s],r);return}o(this,te).insert(e,t,r)}match(e,t){return o(this,te).search(e,t)}},te=new WeakMap,it),kt=class extends Vt{constructor(e={}){super(e),this.router=e.router??new ir({routers:[new sr,new lr]})}},cr=/^\s*(?:text\/(?!event-stream(?:[;\s]|$))[^;\s]+|application\/(?:javascript|json|xml|xml-dtd|ecmascript|dart|msgpack|postscript|rtf|tar|toml|vnd\.dart|vnd\.ms-fontobject|vnd\.ms-opentype|vnd\.msgpack|wasm|x-httpd-php|x-javascript|x-msgpack|x-ns-proxy-autoconfig|x-sh|x-tar|x-virtualbox-hdd|x-virtualbox-ova|x-virtualbox-ovf|x-virtualbox-vbox|x-virtualbox-vdi|x-virtualbox-vhd|x-virtualbox-vmdk|x-www-form-urlencoded)|font\/(?:otf|ttf)|image\/(?:bmp|vnd\.adobe\.photoshop|vnd\.microsoft\.icon|vnd\.ms-dds|x-icon|x-ms-bmp)|message\/rfc822|model\/gltf-binary|x-shader\/x-fragment|x-shader\/x-vertex|[^;\s]+?\+(?:json|text|xml|yaml|msgpack))(?:[;\s]|$)/i,Qe=(e,t=pr)=>{const r=/\.([a-zA-Z0-9]+?)$/,a=e.match(r);if(a)return t[a[1].toLowerCase()]},dr={aac:"audio/aac",avi:"video/x-msvideo",avif:"image/avif",av1:"video/av1",bin:"application/octet-stream",bmp:"image/bmp",css:"text/css; charset=utf-8",csv:"text/csv; charset=utf-8",eot:"application/vnd.ms-fontobject",epub:"application/epub+zip",gif:"image/gif",gz:"application/gzip",htm:"text/html; charset=utf-8",html:"text/html; charset=utf-8",ico:"image/x-icon",ics:"text/calendar; charset=utf-8",jpeg:"image/jpeg",jpg:"image/jpeg",js:"text/javascript; charset=utf-8",json:"application/json",jsonld:"application/ld+json",map:"application/json",mid:"audio/x-midi",midi:"audio/x-midi",mjs:"text/javascript; charset=utf-8",mp3:"audio/mpeg",mp4:"video/mp4",mpeg:"video/mpeg",oga:"audio/ogg",ogv:"video/ogg",ogx:"application/ogg",opus:"audio/opus",otf:"font/otf",pdf:"application/pdf",png:"image/png",rtf:"application/rtf",svg:"image/svg+xml; charset=utf-8",tif:"image/tiff",tiff:"image/tiff",ts:"video/mp2t",ttf:"font/ttf",txt:"text/plain; charset=utf-8",wasm:"application/wasm",webm:"video/webm",weba:"audio/webm",webmanifest:"application/manifest+json",webp:"image/webp",woff:"font/woff",woff2:"font/woff2",xhtml:"application/xhtml+xml; charset=utf-8",xml:"application/xml; charset=utf-8",zip:"application/zip","3gp":"video/3gpp","3g2":"video/3gpp2",gltf:"model/gltf+json",glb:"model/gltf-binary"},pr=dr,fr=(...e)=>{let t=e.filter(s=>s!=="").join("/");t=t.replace(new RegExp("(?<=\\/)\\/+","g"),"");const r=t.split("/"),a=[];for(const s of r)s===".."&&a.length>0&&a.at(-1)!==".."?a.pop():s!=="."&&a.push(s);return a.join("/")||"."},Et={br:".br",zstd:".zst",gzip:".gz"},mr=Object.keys(Et),ur="index.html",hr=e=>{const t=e.root??"./",r=e.path,a=e.join??fr;return async(s,i)=>{var p,f,g,y;if(s.finalized)return i();let n;if(e.path)n=e.path;else try{if(n=nt(s.req.path),/(?:^|[\/\\])\.{1,2}(?:$|[\/\\])|[\/\\]{2,}/.test(n))throw new Error}catch{return await((p=e.onNotFound)==null?void 0:p.call(e,s.req.path,s)),i()}let l=a(t,!r&&e.rewriteRequestPath?e.rewriteRequestPath(n):n);e.isDir&&await e.isDir(l)&&(l=a(l,ur));const c=e.getContent;let d=await c(l,s);if(d instanceof Response)return s.newResponse(d.body,d);if(d){const v=e.mimes&&Qe(l,e.mimes)||Qe(l);if(s.header("Content-Type",v||"application/octet-stream"),e.precompressed&&(!v||cr.test(v))){const E=new Set((f=s.req.header("Accept-Encoding"))==null?void 0:f.split(",").map(j=>j.trim()));for(const j of mr){if(!E.has(j))continue;const C=await c(l+Et[j],s);if(C){d=C,s.header("Content-Encoding",j),s.header("Vary","Accept-Encoding",{append:!0});break}}}return await((g=e.onFound)==null?void 0:g.call(e,l,s)),s.body(d)}await((y=e.onNotFound)==null?void 0:y.call(e,l,s)),await i()}},gr=async(e,t)=>{let r;t&&t.manifest?typeof t.manifest=="string"?r=JSON.parse(t.manifest):r=t.manifest:typeof __STATIC_CONTENT_MANIFEST=="string"?r=JSON.parse(__STATIC_CONTENT_MANIFEST):r=__STATIC_CONTENT_MANIFEST;let a;t&&t.namespace?a=t.namespace:a=__STATIC_CONTENT;const s=r[e];if(!s)return null;const i=await a.get(s,{type:"stream"});return i||null},vr=(e={})=>async function(r,a){return hr({...e,getContent:async i=>gr(i,{manifest:e.manifest,namespace:e.namespace?e.namespace:r.env?r.env.__STATIC_CONTENT:void 0})})(r,a)},br=e=>vr(e);const U=new kt;U.use("/static/*",br({root:"./public"}));U.get("/",e=>e.html(yr()));U.get("/about",e=>e.html(xr()));U.get("/projects",e=>e.html(jt()));U.get("/projects/:slug",e=>{const t=e.req.param("slug"),r=kr(t);return r?e.html(r):e.html(jt())});U.get("/contact",e=>e.html(Er()));U.post("/api/contact",async e=>{var g;const t=await e.req.json(),{firstName:r,lastName:a,company:s,email:i,phone:n,projectType:l,units:c,message:d}=t,p=((g=e.env)==null?void 0:g.RESEND_API_KEY)||"re_cUWsgWQS_ADvgH3quA64U1cpoVRqAo4CQ",f=`
  ...
  `;try{const y=await fetch("https://api.resend.com/emails",{method:"POST",headers:{Authorization:`Bearer ${p}`,"Content-Type":"application/json"},body:JSON.stringify({from:"ARTé Website <onboarding@resend.dev>",to:["enquiries@arte-living.com"],reply_to:i||void 0,subject:`New Enquiry${s?` — ${s}`:""}${l?` (${l})`:""}`,html:f})});if(!y.ok){const v=await y.text();return console.error("Resend error:",v),e.json({success:!1,message:"Failed to send enquiry. Please email us directly at enquiries@arte-living.com"},500)}return e.json({success:!0,message:"Thank you for your enquiry. A member of our team will contact you within one business day."})}catch(y){return console.error("Contact form error:",y),e.json({success:!1,message:"Failed to send enquiry. Please email us directly at enquiries@arte-living.com"},500)}});function Ce(e){return`
  ...
  `}function yr(){return Re("Home","ARTé crafts bespoke furniture for luxury hotels, serviced apartments, offices, and student housing. The Living Standard.")+`
...
${Te()}`}function xr(){return Re("About Us","ARTé is a bespoke contract furniture specialist with 15 years of experience supplying luxury hotels, serviced apartments, offices and student housing.")+`
...
${Te()}`}function jt(){const e=[{title:"Hyatt Regency Resort",location:"China",locationKey:"china",sector:"Luxury Hotel",tier:"Premium Hospitality",scope:"Full FF&E supply — guest rooms, suites, lobby & resort facilities",slug:"hyatt-regency-resort-china",img:"/static/hyatt-regency-china-cover.jpg",gallery:[{src:"/static/hyatt-regency-china-cover.jpg",caption:"Aerial view — resort complex at dusk"},{src:"/static/hyatt-regency-suite.jpg",caption:"Premier Suite — bedroom, living room & marble bathroom"},{src:"/static/hyatt-regency-guestroom.jpg",caption:"Deluxe Guest Room — bespoke headboard, timber furniture & sea view"},{src:"/static/hyatt-regency-restaurant.jpg",caption:"All-Day Dining Restaurant — custom banquette seating & joinery"},{src:"/static/hyatt-regency-restaurant2.jpg",caption:"Specialty Restaurant — dining furniture across multiple F&B outlets"}]},{title:"Guangzhou Financial Tower",location:"Guangzhou, China",locationKey:"china",sector:"Corporate Office",tier:"Premium Office",scope:"Reception lobby, executive offices & full-floor fit-out",slug:"guangzhou-financial-tower",img:"/static/gz-office-cover.jpg",gallery:[{src:"/static/gz-office-cover.jpg",caption:"Reception Lobby — marble joinery counter with brass trim"}]},{title:"Shenzhen Corporate Centre",location:"Shenzhen, China",locationKey:"china",sector:"Corporate Office",tier:"Premium Office",scope:"Conference suites, executive offices & open-plan floors",slug:"shenzhen-corporate-centre",img:"/static/china-office-cover.jpg",gallery:[{src:"/static/china-office-cover.jpg",caption:"Conference Suite — glass-walled meeting rooms with city views"},{src:"/static/china-office-lounge.jpg",caption:"Reception & Lounge — curved joinery counter, breakout seating"},{src:"/static/china-office-exec.jpg",caption:"Executive Office — bespoke desk, shelving & visitor seating"},{src:"/static/china-office-openplan.jpg",caption:"Open-Plan Floor — full workstation fit-out, night view"},{src:"/static/china-office-workstations.jpg",caption:"Workstation Area — ergonomic benching with amber-panel screens"}]},{title:"Harbour View Executive Suite",location:"Hong Kong",locationKey:"hk",sector:"Corporate Office",tier:"Premium Office",scope:"Executive suite, boardroom, lounge & open-plan floors",slug:"harbour-view-executive-suite",img:"/static/FveZLY8q.jpg",gallery:[{src:"/static/FveZLY8q.jpg",caption:"Executive Office — Victoria Harbour view"},{src:"/static/hk-office-boardroom.jpg",caption:"Boardroom — 12-seat conference table, harbour aspect"},{src:"/static/hk-office-exec-room.jpg",caption:"Director's Office — bespoke desk & executive seating"},{src:"/static/hk-office-bar.jpg",caption:"Hospitality Bar — walnut joinery, marble countertop"},{src:"/static/hk-office-lounge.jpg",caption:"Client Lounge — panoramic harbour & skyline views"},{src:"/static/hk-office-openplan.jpg",caption:"Open-Plan Working Floor — full workstation fit-out"}]}],t={"Luxury Hotel":"hotel","Corporate Office":"office","Student Housing":"student","Serviced Apartments":"residential","Senior Living":"residential"},r=e.map((a,s)=>{const i=t[a.sector]||"other",n=a.locationKey||"other",l=a.slug,c=!!l,d=c?`a href="/projects/${l}"`:"div",p=c?"a":"div";return`
  ...
  `}).join("");return Re("Projects","Browse ARTé's portfolio of bespoke furniture projects spanning luxury hotels, serviced apartments, offices, student housing and more.")+`
...
${Te()}`}const wr={"hyatt-regency-resort-china":{title:"Hyatt Regency Resort",location:"China",sector:"Luxury Hotel",tier:"Premium Hospitality",scope:"Full FF&E supply — guest rooms, suites, lobby & resort facilities",year:"2024",description:`A full-scale FF&E supply project for a Hyatt Regency resort property in China, encompassing every furniture category across a large-format resort destination.
...
The resort's multiple food and beverage outlets were also furnished as part of the scope: custom banquette seating, dining chairs and tables for the all-day restaurant, and bespoke furniture across the specialty dining venues. Each outlet was treated as a distinct design environment while maintaining a coherent material language throughout the property.`,gallery:[{src:"/static/hyatt-regency-china-cover.jpg",caption:"Aerial view — resort complex at dusk"},{src:"/static/hyatt-regency-suite.jpg",caption:"Premier Suite — bedroom, living room & marble bathroom"},{src:"/static/hyatt-regency-guestroom.jpg",caption:"Deluxe Guest Room — bespoke headboard, timber furniture & sea view"},{src:"/static/hyatt-regency-restaurant.jpg",caption:"All-Day Dining Restaurant — custom banquette seating & joinery"},{src:"/static/hyatt-regency-restaurant2.jpg",caption:"Specialty Restaurant — dining furniture across multiple F&B outlets"}]},"guangzhou-financial-tower":{title:"Guangzhou Financial Tower",location:"Guangzhou, China",sector:"Corporate Office",tier:"Premium Office",scope:"Reception lobby, executive offices & full-floor fit-out",year:"2024",description:`A prestige office fit-out in Guangzhou's financial district, designed to project quiet authority from the moment a visitor steps off the lift. ARTé delivered the complete furniture and joinery package across the reception lobby and executive floors.
...
The result is an environment that projects authority and confidence while remaining genuinely comfortable for the people who work in it every day.`,gallery:[{src:"/static/FveZLY8q.jpg",caption:"Executive Office — Victoria Harbour view"},{src:"/static/hk-office-boardroom.jpg",caption:"Boardroom — 12-seat conference table, harbour aspect"},{src:"/static/hk-office-exec-room.jpg",caption:"Director's Office — bespoke desk & executive seating"},{src:"/static/hk-office-bar.jpg",caption:"Hospitality Bar — walnut joinery, marble countertop"},{src:"/static/hk-office-lounge.jpg",caption:"Client Lounge — panoramic harbour & skyline views"},{src:"/static/hk-office-openplan.jpg",caption:"Open-Plan Working Floor — full workstation fit-out"}]}};function kr(e){var y;const t=wr[e];if(!t)return null;const{title:r,location:a,sector:s,tier:i,scope:n,year:l,description:c,gallery:d}=t,p=((y=d[0])==null?void 0:y.src)??"",f=d.map((v,E)=>`
  ...
  `).join("");return Re(r,`${r} — ${s} project in ${a} by ARTé. ${n}.`)+`
...
${Te()}`}function Er(){return Re("Contact","Get in touch with ARTé to discuss your B2B furniture project — hotels, offices, student housing and more.")+`
