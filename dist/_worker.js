...
${Te()}`}const wr={"hyatt-regency-resort-china":{title:"Hyatt Regency Resort",location:"China",sector:"Luxury Hotel",tier:"Premium Hospitality",scope:"FF&E supply — guest rooms, suites, lobby & resort facilities",year:"2022",description:`A full-scale FF&E supply project for a Hyatt Regency resort property in China, encompassing every furniture category across a large-format resort destination.
